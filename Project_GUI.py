...
class Window(Frame):
    def __init__(self, master=None):
        ...
        self.filename = "D:/TrafficSignalProject/home.jpg"
    ...
    def open_file(self):
        ...
        ret, image = cap.read()
        cv2.imwrite("D:/TrafficSignalProject/preview.jpg", image)

        self.show_image("D:/TrafficSignalProject/preview.jpg")
    ...
    def imgClick(self, event):
        ...
        if self.counter == 2:
            ...
            print(self.line)
            print(self.rect)
            img = cv2.imread("D:/TrafficSignalProject/preview.jpg")
            cv2.line(img, self.line[0], self.line[1], (0, 255, 0), 3)
            cv2.imwrite("D:/TrafficSignalProject/copy.jpg", img)
            self.show_image("D:/TrafficSignalProject/copy.jpg")
    ...
    def main_process(self):
        ...
        fps = reader.get_meta_data()['fps']    
        writer = imageio.get_writer("D:/TrafficSignalProject/Output/output.mp4", fps = fps)
